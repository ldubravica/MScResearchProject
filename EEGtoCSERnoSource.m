function [cser_values, eeg_source, aals] = EEGtoCSERnoSource()
    ...
    for i = 1:length(files)
        ...
        [H_open, bH_open] = StateSpaceEntropyRate(rotated_open, Fs, 'yes', bands);
        [H_closed, bH_closed] = StateSpaceEntropyRate(rotated_closed, Fs, 'yes', bands);
    ...
    save(fullfile('cser_values_no_source.mat'), ...
        'cser_open', 'cser_closed', 'cser_band_open', 'cser_band_closed', 'source_names');
