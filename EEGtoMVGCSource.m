function [mvgc_open, mvgc_closed, ss_info_open, ss_info_closed] = EEGtoMVGCSource()
    ...
    % addpath(strrep(p, 'EEGtoMVGCSource', 'EntRate/private/mvgc_v2.0'));
    % evalc('mvgc_startup;');
    ...
    if LOAD_MVGC_FILE
        ...
        if exist('mvgc_values.mat', 'file')
            ...
            fprintf('No MVGC results found. Please run EEGtoMVGCSource first.\n');
            return;
        end
