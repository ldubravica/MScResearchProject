/*************************************************************
 *
 * This function is copied verbatim from the Fieldtrip toolbox, revision
 * ee06d96dd. Full credit goes to Robert Oostenveld and the original Fieldtrip
 * authors. This function is licenced under a GPL-v3 licence.
 *
 *
 * For more information see the Fieldtrip website:
 *
